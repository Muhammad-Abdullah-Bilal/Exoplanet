...
import Enhanced3DPlanet from '../components/Enhanced3DPlanet';
          ...
          >
            <div className="planet-visual">
              <Enhanced3DPlanet 
                ...
                hasAtmosphere={planet.type !== 'Rocky'}
                planetType={planet.type === 'Gas Giant' ? 'gas-giant' : 
                           planet.type === 'Rocky' ? 'terrestrial' : 'ice-giant'}
                style={{ height: '80px' }}
              />
            </div>
            ...
            <div className="modal-content">
              <div className="modal-planet">
                <Enhanced3DPlanet 
                  ...
                  hasAtmosphere={selectedPlanet.type !== 'Rocky'}
                  planetType={selectedPlanet.type === 'Gas Giant' ? 'gas-giant' : 
                             selectedPlanet.type === 'Rocky' ? 'terrestrial' : 'ice-giant'}
                  rotationSpeed={1.5}
                  style={{ height: '200px' }}
                />
              </div>
