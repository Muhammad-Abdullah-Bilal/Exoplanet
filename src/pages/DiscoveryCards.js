        ...
        <div className="card-container">
          <div className="discovery-card">
            <div className="card-image">
              <img src={currentDiscovery.image} alt={currentDiscovery.name} />
            ...
            <div className="card-3d-planet">
              <Enhanced3DPlanet 
                color={currentDiscovery.type === 'Super-Earth' ? '#81c784' : 
                       currentDiscovery.type === 'Gas Giant' ? '#ffb74d' : '#4fc3f7'}
                size="large"
                hasRings={currentDiscovery.type === 'Gas Giant'}
                hasAtmosphere={true}
                planetType={currentDiscovery.type === 'Gas Giant' ? 'gas-giant' : 
                           currentDiscovery.type === 'Super-Earth' ? 'terrestrial' : 'ice-giant'}
                style={{ height: '250px' }}
              />
            </div>
